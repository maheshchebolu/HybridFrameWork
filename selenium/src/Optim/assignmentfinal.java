...
public class assignmentfinal {
	...
	public void assignment() throws InterruptedException  {
		...
		mywait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.xpath("//input[@id='username-uid1']"))));
		...
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("automation test Board");
		...
		Assert.assertEquals(driver.getTitle().equals("Boards | Trello"), true);
		...
		if(driver.getTitle().equals("Automation Test Board"))
		{
			break;
		}
		}
		
		driver.findElement(By.xpath("//span[text()='automation test Board']")).click();
